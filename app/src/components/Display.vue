    ...
    <form novalidate>
        <div class="row g-2">
            <div class="col-6">
                ...
                <input v-model="display.min_dbm" type="number" class="form-control form-control-sm" id="min_dbm"
                    required step="0.1" />
            ...
            <div class="col-6">
                ...
                <input v-model="display.max_dbm" type="number" class="form-control form-control-sm" id="max_dbm"
                    required step="0.1" />
        ...
        <div class="row g-2 mt-2">
            ...
            <div class="col-6">
                ...
                <input v-model="display.overlay_transparency" type="number" class="form-control form-control-sm"
                    id="overlay_transparency" required min="0" max="100" step="1" />
                <div class="invalid-feedback">Transparency must be between 0 and 100 (default: 50).</div>
            </div>
        </div>
        <div class="mt-3 text-center">
            <div>
                <img :src="`/colormaps/${display.color_scale}.png`" alt="Colorbar" width="256" height="30"

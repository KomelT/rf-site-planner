    ...
    <form novalidate>
        <div class="row g-2">
            <div class="col-6">
                ...
                <select v-model="environment.radio_climate" id="radio_climate" class="form-select form-select-sm"
                    required>
            ...
            <div class="col-6">
                ...
                <select v-model="environment.polarization" id="polarization" class="form-select form-select-sm"
                    required>
            ...
            <div class="col-6">
                ...
                <input v-model="environment.clutter_height" type="number" class="form-control form-control-sm"
                    id="clutter_height" required min="0" step="0.1" />
            ...
            <div class="col-6">
                ...
                <input v-model="environment.ground_dielectric" type="number" class="form-control form-control-sm"
                    id="ground_dielectric" required min="1" step="0.1" />
            ...
            <div class="col-6">
                ...
                <input v-model="environment.ground_conductivity" type="number" class="form-control form-control-sm"
                    id="ground_conductivity" required min="0" step="0.001" />
            ...
            <div class="col-6">
                ...
                <input v-model="environment.atmosphere_bending" type="number" class="form-control form-control-sm"
                    id="atmosphere_bending" required min="0" step="0.1" />
